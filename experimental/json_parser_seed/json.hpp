#ifndef EQUORUS_EXPERIMENTAL_JSON_HPP
#define EQUORUS_EXPERIMENTAL_JSON_HPP
...
namespace equorus::experimental {
...
/**
 * Experimental zero-dependency C++20 JSON parser seed.
 *
 * Lineage: adapted from VINOX src/serving/json.hpp at commit
 * 152b2b5842ea8f3c70ae15a38abc097af03f456d.
 *
 * SECURITY/SCOPE BOUNDARY:
 * This code is preserved for parser research. It is not a production EQUORUS
 * codec and is not approved for untrusted network/API/MCP input.
 */
class JsonParser {
public:
    ...
    JsonValue parse_number() {
        ...
        while (pos_ < input_.size() &&
               (std::isdigit(static_cast<unsigned char>(input_[pos_])) || input_[pos_] == '.' ||
                input_[pos_] == 'e' || input_[pos_] == 'E' || input_[pos_] == '+' || input_[pos_] == '-')) {
            ++pos_;
        }
